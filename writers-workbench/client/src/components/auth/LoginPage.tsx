...
// Hidden until Supabase Google provider is configured (Client ID/Secret in
// dashboard + redirect URI added in Google Cloud). Flip the env var to "true"
// once both are set up. Keeps the UI from showing a button that errors out.
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <PasswordInput
              ...
              className="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
            />
          </div>
