...
> **⚑ B-roll source — Tech Ahir landing page (scenes 7–8):** https://lp.techahir.com/3day-minimum-viable-product-mvp
> Scenes 1–6 are the product demo (unchanged). **Scenes 7–8 reframe the video as a Tech Ahir MVP showcase:** The Writers Workbench is the example MVP Tech Ahir built — and it's literally featured on this page in the **"PROOF — LIVE APPLICATIONS"** section. B-roll for scenes 7–8 pulls from this page: **hero** ("A working SaaS MVP. In 3 days. From $1,500.") → **PROOF / Writer's Workbench case study** → **final CTA / "Book a Call"**. Put this same URL in the scene 8 caption and the video description (the CTA narration says "link in the description").

Paste this verbatim into the Heygen script editor. Total runtime ~3:00 at default voice pace (~140 wpm), ~435 words. Plain text — no markdown, no asterisks. Em-dashes and periods provide natural pauses. Scenes 1–6 are unchanged; scenes 7–8 are the Tech Ahir MVP call-to-action.
...
Here's the twist. Everything you just saw — the voice, the drift scanner, the whole platform — is a working MVP that Tech Ahir built. Real auth. Real data. Deployed live. Not a mockup — a real product your customers can use.

Have an idea of your own? Tech Ahir builds working SaaS MVPs in as little as three days, from fifteen hundred dollars. Book a call — the link's in the description.
```
...
| 7 — Tech Ahir reveal | Here's the twist. Everything you just saw — the voice, the drift scanner, the whole platform — is a working MVP that Tech Ahir built. Real auth. Real data. Deployed live. Not a mockup — a real product your customers can use. |
| 8 — Tech Ahir CTA | Have an idea of your own? Tech Ahir builds working SaaS MVPs in as little as three days, from fifteen hundred dollars. Book a call — the link's in the description. |
...
| 0:55–1:35 | 4 — Story bible + drift + Q/A | Every project has a Story Bible... drift scanner... Q and A engine...                               | 1) Open ProjectDetail → Story Bible tab. Show ~10 entries (characters, events, locations).<br>2) Open ContentDetail on Ch3 → click AnnotationsPanel → show "Maya Chan" drift finding → click Apply → text updates in editor.<br>3) Open the project's **Q/A tab** → show every chapter's craft-QA + consistency status in one grid → click into a chapter's **Q/A Consistency Report** panel → show the 9 checks (green + one yellow) → click **Rewrite to fix Q/A** (queues a targeted rewrite).<br>Hold ~3 sec on each step.                                                                                                                                                                                                                                                                 | `[CAPTION at 1:08: "Story Bible auto-built"]`<br>`[CAPTION at 1:18: "One-click drift fix"]`<br>`[CAPTION at 1:28: "9 craft dimensions"]`                                                                                                                                                |
...
| 2:35–2:52 | 7 — Tech Ahir reveal          | Here's the twist... a working MVP that Tech Ahir built... real auth, real data, deployed live...    | B-roll from the **Tech Ahir landing page** (`https://lp.techahir.com/3day-minimum-viable-product-mvp`). Cut from the Workbench app to the **hero** — "A working SaaS MVP. In 3 days. From $1,500." + subhead "Real auth. Real data. Deployed live. Source code in your GitHub by Friday." Hold ~2 sec. Scroll to the **"PROOF — LIVE APPLICATIONS"** section and hold ~4 sec on the **Writer's Workbench** case-study card — the exact app just demoed, tying "everything you just saw" to "built by Tech Ahir." Optional: brush the value-prop row (Fixed price · Source & IP ownership · On-time guarantee). | `[CAPTION at 2:40: "Built by Tech Ahir"]`<br>`[CAPTION at 2:48: "Working MVP in 3 days · from $1,500"]`                                                                                                                                                                                 |
| 2:52–3:00 | 8 — Tech Ahir CTA             | Have an idea of your own?... in as little as three days, from fifteen hundred dollars. Book a call. | Scroll to the **final CTA — "THIS IS THE MOMENT"** section (or the **"Choose your MVP build package"** tiles showing Starter $1,500 / 3 days). Hold on the **"Book a Call →"** button; animate the URL `lp.techahir.com/3day-minimum-viable-product-mvp` typing-on beneath it. Cut to black on the URL.                                                                                                                                                                                                                                                                                                        | `[CAPTION at 2:56: "lp.techahir.com/3day-minimum-viable-product-mvp"]`                                                                                                                                                                                                                  |
...
- [ ] Scene 7 Tech Ahir reveal — landing-page hero ("MVP in 3 days, from $1,500") + "PROOF — LIVE APPLICATIONS" Writer's Workbench card, ~17 sec.
- [ ] Scene 8 Tech Ahir CTA — landing-page "THIS IS THE MOMENT" / "Book a Call" + URL type-on, ~8 sec.
...
- Put the Tech Ahir landing-page URL (`https://lp.techahir.com/3day-minimum-viable-product-mvp`) in the **video description** — the scene 8 CTA narration says "the link's in the description." (It's already in the §3 callout + scene 8 caption.)
- Writer's Workbench is confirmed present on the landing page in the **"PROOF — LIVE APPLICATIONS"** section, so scene 7's "built by Tech Ahir" cut lands visually. If that section changes, re-check the shot list.
- Verify the landing-page figures still match the narration before publishing: **"3 days," "from $1,500" (fifteen hundred dollars)**. If Tech Ahir changes pricing/timeline, re-record scenes 7–8 voice via Heygen and re-cut.
